                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group" style="width: 100%;">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <input name="old_image" type="hidden" value="{{ $structure->en->content->image }}">
                                    ...
                                    <div class="col-4" style="display: flex;">
                                        <img src="{{ $structure->en->content->image }}" id="aboutUsImage" style="width: 60%;">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="en[content][title]" value="{{$structure->en->content->title}}" type="text" class="form-control" id="exampleInputTitle1" placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputTitle2">@lang('dashboard.Title Ar')</label>
                                            <input name="ar[content][title]" value="{{$structure->ar->content->title}}" type="text" class="form-control" id="exampleInputTitle2" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="en[content][content]" id="exampleInputContent1" class="form-control" rows="8" placeholder="">{{$structure->en->content->content}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputContent2">@lang('dashboard.Content Ar')</label>
                                            <textarea name="ar[content][content]" id="exampleInputContent2" class="form-control" rows="8" placeholder="">{{$structure->ar->content->content}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
