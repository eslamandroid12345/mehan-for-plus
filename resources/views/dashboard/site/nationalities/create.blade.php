...
@section('title', __('titles.Create Nationality'))
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('nationalities.store') }}" method="post" autocomplete="off">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create Nationality')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
