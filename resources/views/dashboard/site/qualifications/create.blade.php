...
@section('title', __('titles.Create Qualification'))
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('qualifications.store') }}" method="post" autocomplete="off">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create Qualification')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
