...
@section('title', __('titles.Non-Resident Seeker Details'))
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.Show Non-Resident Seeker')</h3>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                @endif
                                @if(!is_null($user->seeker->is_worked_before_in_ksa))
                                    <tr>
                                        <td><b>@lang('dashboard.Is worked before in KSA?'):</b> {{ $user->seeker->is_worked_before_in_ksa == 1 ? __('dashboard.Yes') : __('dashboard.No') }}</td>
                                    </tr>
                                @endif
